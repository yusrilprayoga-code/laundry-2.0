        ...
        <div class="login-card">
            ...
            <div class="login-card-header">
                ...
                <div>
                    ...
                    ?>
                        <?php echo "Please login to use the platform" ?>
                    <?php
                    }
                    ?>
                </div>
            ...
            <form method="POST" action="cek_login.php" class="login-card-form">
                <div class="form-item">
                    ...
                    <input type="text" name="username" placeholder="Enter Username" id="emailForm" value="<?php if(isset($_COOKIE["member_login"])) { echo $_COOKIE["member_login"]; } ?>" autofocus required>
                </div>
                <div class="form-item">
